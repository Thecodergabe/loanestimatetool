...
# Download ZIP-to-county CSV
$zipCsvUrl = "https://raw.githubusercontent.com/scpike/us-state-county-zip/master/geo-data.csv"
$zipCsvPath = "$DataDir\zip_to_county.csv"
Invoke-WebRequest -Uri $zipCsvUrl -OutFile $zipCsvPath
Write-Host "✅ Downloaded ZIP-to-county CSV"

# Write Node.js script to file
$nodeScriptPath = "$DataDir\generate-tax.js"
@'
